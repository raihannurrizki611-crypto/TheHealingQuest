...
public class StoryManager {
    ...
    public enum StoryStage {
        ...
        // ── Dialog kasual — HARUS sebelum MASUK_1_2 agar isBagian11() benar
        // isBagian11() cek: stage >= PILIHAN_SAPA_RADJA && stage < MASUK_1_2
        DIALOG_KASUAL,
    ...
    private StoryStage previousStage   = StoryStage.INTRO; // stage sebelum dialog kasual
    ...
    /** Masuk dialog kasual — simpan stage saat ini dulu */
    public void masukDialogKasual() {
        this.previousStage = this.currentStage;
        this.currentStage  = StoryStage.DIALOG_KASUAL;
    }

    /** Keluar dialog kasual — restore stage sebelumnya */
    public void keluarDialogKasual() {
    ...
    public void pilihanSaatNotif(boolean fokusRadja) {
        // fokusRadja=true → pilih1 (abaikan mantan, fokus Radja)
        // fokusRadja=false → pilih2 (balas mantan)
        currentStage = fokusRadja ? StoryStage.FOKUS_RADJA : StoryStage.BALAS_MANTAN;
    }
